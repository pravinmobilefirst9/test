...
export class AppMenuComponent implements OnInit {
  ...
  constructor(public app: AppComponent, private menuService: SbMenuService, public authService: SbAuthenticationService) { }
  ...
  ngAfterViewInit() {
    ...
    if (this.authService.isAuthenticated()) {
      setTimeout(() => {
        this.observable = this.authService.userInfoSubject;
        this.subscription = this.observable.subscribe(userInfo => {
          this.userName = userInfo.username;
          this.userRoles = userInfo.prettyPrintedRoles();
        });
      });
    }
